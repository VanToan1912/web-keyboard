...
<head>
    ...
    <title>Xác minh Email - KeyCraft</title>
        ...
        <div class="col-md-6 col-lg-5">
            <div class="verify-card">
                ...
                <form action="/auth/verify-code" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="code" name="code" required pattern="[0-9]{6}" placeholder="Enter 6-digit code">
                        </div>
                    </div>
                ...
                <div class="text-center">
                    <p class="mb-0">Chưa nhận được mã? <a href="/auth/resend-verification" class="text-indigo-600 text-decoration-none">Gửi lại mã</a></p>
                    <p class="mt-2"><a href="/signup" class="text-gray-500 text-decoration-none">← Quay lại đăng ký</a></p>
                </div>
            </div>
        </div>
    </div>
